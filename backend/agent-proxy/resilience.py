...
The seven categories are the agent error contract shared with desktop clients:
the category decides the user-plane message and the retry policy; the raw
exception always goes whole to the internal log.
"""
